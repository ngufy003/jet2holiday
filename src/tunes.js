...
export function felix_tune (cpm = 120, muteS1 = false, muteS5 = false, muteSS = false, volume = 1, lpf = 1000) { 
return `setcpm(${cpm});
...
${muteSS ? '_' : ''}s2: note("c2 [eb3,g3]".add("<0 <1 -1>>"))
.adsr("[.1 0]:.2:[1 0]").sound("gm_acoustic_bass")
.room(.7)


${muteSS ? '_' : ''}s4: s("sbd:2!4").note("e2").duck("2:3")
